    ...
    <MainContainer>
      ...
      <Box sx={{ marginTop: 4 }}>
        ...
        <StyledPaper>
          ...
          <List>
            <ListItem>
              <Link href="https://www.google.com/search?q=MLOps+best+practices" target="_blank" rel="noopener noreferrer" color="secondary">
                Google Search for "MLOps Best Practices"
              </Link>
            </ListItem>
            <ListItem>
              <Link href="https://www.google.com/search?q=MLOps+tools" target="_blank" rel="noopener noreferrer" color="secondary">
                Google Search for "MLOps Tools"
              </Link>
            </ListItem>
            <ListItem>
              <Link href="https://www.mlops.community/" target="_blank" rel="noopener noreferrer" color="secondary">
                MLOps Community
              </Link>
            </ListItem>
          </List>
